      ...
      <div className="max-w-screen-2xl mx-auto container md:px-20 px-4 flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 mt-12 md:mt-32 order-2">
          <div className="md:space-y-8 space-y-8">
            ...
            <p className="text-xl">
              Embrace each day as an opportunity to grow and expand your
              horizons. Let's make each day an adventure in knowledge! 🌟📚✨
            </p>
          ...
          <button className="btn btn-secondary md:mt-3 mt-6">
            Get Started
          </button>
        </div>
        <div className="w-full md:w-1/2">
          <img src={banner} className="w-92 h-92 order-1" alt="banner" />
        </div>
      </div>
    </>
  );
